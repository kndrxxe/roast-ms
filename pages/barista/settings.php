                            ...
                            <div class="card h-100">
                                <div class="card-header fw-bold">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">Profile Picture</div>
                                        <div class="col-auto">
                            ...
                            <div class="modal fade" id="editProfilePictureModal" tabindex="-1" aria-labelledby="editProfilePictureModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="/roast-ms/pages/barista/api/upload_picture" method="POST" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                <div class="form-floating mb-3">
                                                    <input type="file" class="form-control" id="profilePicture" name="picture" accept="image/*" required>
                                                    <label for="profilePicture" class="fw-bold">Select New Picture</label>
                                                </div>

                                                <!-- Hidden user ID input -->
                                                <input type="hidden" name="user_id" id="update_user_id" value="<?php echo htmlspecialchars($id); ?>">
                                            </div>
                                    ...
                                    <div class="card h-100">
                                        <div class="card-header fw-bold">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="col-auto">
                                                    <button type="button" class="btn btn-dark editnamebtn" data-bs-toggle="modal"
                                    ...
                                    <div class="card h-100">
                                        <div class="card-header fw-bold">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="col-auto">
                                                    <button type="button" class="btn btn-dark editusernamebtn" data-bs-toggle="modal"
                                                        data-bs-target="#editUsernameModal">
                                                        <i class="bi bi-pencil-fill"></i> Edit
                                                    </button>
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            if (isset($_SESSION['updatefailed'])) {
                echo "toastr.error('" . $_SESSION['updatefailed'] . "', 'Error');";
    ...
    <script>
        $(document).ready(function() {
            $('.editbtn').on('click', function() {
                ...
                console.log("User ID:", userId); // Debug check in console

                // Ensure the hidden input exists
                $('#update_user_id').val(userId);

                // Show modal (optional because Bootstrap 5's data-bs-toggle already does it)

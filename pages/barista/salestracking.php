...
checkRole(['Barista']); // Only Barista can access
?>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="/roast-ms/assets/images/default-150x150.png"
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <li class="user-header text-bg-dark">
                                <img src="/roast-ms/assets/images/default-150x150.png" class="rounded-circle shadow"
                                    alt="User" />
                                <p>
        ...
        <aside class="app-sidebar bg-dark shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-wrapper">
                <div class="user-panel py-2 d-flex align-items-center">
                    <div class="image">
                        <img width="50" src="/roast-ms/assets/images/default-150x150.png"
                            class="rounded-circle shadow ms-1 me-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a
        ...
        <main class="app-main">
            ...
            <div class="app-content">
                <div class="container-fluid">
                        ...
                        <div class="data_table">
                            ...
                            <table id="salesTable" class="table table-hover table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $result = $conn->prepare("SELECT * FROM sales WHERE barista = ? ORDER BY sale_date DESC");
                                    $result->bind_param("s", $currentUser);
                                    $result->execute();
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-dark" data-bs-toggle="modal"
                                                    data-bs-target="#viewSalesModal" data-id="<?= $row['id'] ?>"
                                                    data-date="<?= $row['sale_date'] ?>" data-shift="<?= $row['shift'] ?>"
                                                    data-barista="<?= $row['barista'] ?>">
                                                    <i class="bi bi-eye-fill"></i>
                                                </button>
                                                <button type="button" class="btn btn-dark" data-bs-toggle="modal"
                                                    data-bs-target="#editSalesModal" data-id="<?= $row['id']; ?>">
                    ...
                    <!-- ADD Sales Modal -->
                    <div class="modal fade" id="addSalesModal" tabindex="-1" aria-labelledby="addSalesLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form action="/roast-ms/pages/barista/api/add_sale" method="POST"
                                ...
                                {$row['category']} - {$row['name']} - {$row['size']}
                                                    ...
                                                    <td>
                                                        <input type="number" name="quantity[]"
                                                            class="form-control quantityInput" value="1" min="1"
                                                            required>
                                                    </td>
                                                    <td>
                                                        <span class="unitPrice">₱0</span>
                                                        <!-- Hidden input to send unit price -->
                                                        <input type="hidden" name="unit_price[]" class="unitPriceInput"
                                                            value="0">
                                                    </td>
                                                    <td>
                                                        <span class="totalPrice">₱0</span>
                                                        <!-- Hidden input to send total -->
                                                        <input type="hidden" name="total[]" class="totalPriceInput"
                                                            value="0">
                                                    </td>
                                                    <td>
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="button" id="addRowBtn" class="btn btn-dark btn-sm"><i
                    ...
                    <div class="modal fade" id="editSalesModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <form id="editSalesForm" action="/roast-ms/pages/barista/api/update_sale" method="POST">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <label class="fw-bold">Date</label>
                                                <input type="date" name="sale_date" id="editSaleDate"
                                            ...
                                            <div class="col-md-4">
                                                <label class="fw-bold">Barista</label>
                                                <input type="text" name="barista" id="editBarista"
                                        ...
                                        <button type="button" id="addEditRow" class="btn btn-sm btn-dark"><i
                                                class="bi bi-plus-circle"></i>
                                            Add Row</button>

                                        <div class="mt-3">
                                            <p><strong>Total Quantity Sold:</strong> <span id="editTotalQty">0</span>
                                            </p>
                                            <p><strong>Total Sales Amount:</strong> ₱<span id="editGrandTotal">0</span>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <!-- VIEW Sales Modal -->
                    <div class="modal fade" id="viewSalesModal" tabindex="-1" aria-labelledby="viewSalesLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">

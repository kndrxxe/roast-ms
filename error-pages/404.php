...
<head>
    ...
    <title>404 Not Found | ROAST-MS</title>
    ...
    <div class="container d-flex align-items-center justify-content-center vh-100">
        <div class="col-lg-8 col-md-4">
            <div class="text-center">
                <h1 class="text-dark animate__animated animate__tada fw-bold" style="font-size:150px">404</h1>
                <h2 class="fw-light">Page Not Found</h2>
                <p class="fs-5 py-3">The page you are looking for might have been removed, had its name changed or is temporarily unavailable.</p>
